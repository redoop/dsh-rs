...
pub use crate::api::services::LlmAdapterApi as LlmAdapter;
...
pub fn llm_plugin() -> Arc<dyn Plugin> {
    plugin("llm", |ctx, config: Value| async move {
        ...
        let api: Arc<dyn crate::api::services::LlmRuntimeApi> = Arc::new(runtime.clone());
        ctx.provide(crate::api::LLM_SERVICE, crate::api::services::LlmService::new(api)).await?;
        ctx.provide(crate::api::LLM_STREAMS_SERVICE, streams.clone()).await?;
        ...
        let mock = Arc::new(crate::llm::adapters::mock::MockAdapter::new());
...
pub async fn stream_via_waterfall(
    ctx: &cordis::Context,
    runtime: crate::api::services::LlmService,
    streams: StreamTable,
    options: GenerateOptions,
...
impl crate::api::services::LlmRuntimeApi for LlmRuntime {
    ...
    fn register_adapter(
        &self,
        providers: &[&str],
        adapter: Arc<dyn crate::api::services::LlmAdapterApi>,
    ) -> Result<(), LlmError> {
